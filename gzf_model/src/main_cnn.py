...
from model_zoo import get_embedding, rnn_model,rnn_att_model,cnn_model
...
def run():
    ...
    bst_model_path = '../model/cnn_v1.hdf5'
    pred_path      = '../res/cnn_v1.pkl'
    res_path       = '../res/cnn_v1.csv'

    embed = get_embedding(embedding_matrix, USE_GLOVE, VOCAB, EMBED_HIDDEN_SIZE,
               TRAIN_EMBED, None)

    model = cnn_model(embed, MAX_LEN_TITLE, MAX_LEN_DES, SENT_HIDDEN_SIZE, ACTIVATION, DP, L2,
